  ...
  return (
    <section className="relative min-h-screen overflow-hidden bg-slate-950 pt-16">
      ...
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        <div className="absolute -left-40 -top-40 h-[600px] w-[600px] rounded-full bg-green-500/10 blur-[120px]" />
        <div className="absolute -right-40 top-1/3 h-[500px] w-[500px] rounded-full bg-green-500/8 blur-[120px]" />
        <div className="absolute bottom-0 left-1/2 -translate-x-1/2 h-[300px] w-[800px] rounded-full bg-green-500/5 blur-[100px]" />
        {/* Grid pattern */}
        <div
        ...
        <div className="grid items-center gap-16 lg:grid-cols-2">
          ...
          <div className="animate-fade-in-up">
            ...
            <div className="flex flex-col gap-4 sm:flex-row">
              <a
                href="#contacto"
                className="group inline-flex items-center justify-center gap-2 rounded-xl bg-green-500 px-8 py-4 text-base font-semibold text-white transition-all duration-200 hover:bg-green-400 hover:shadow-xl hover:shadow-green-500/30"
              >
